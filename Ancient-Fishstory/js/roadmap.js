 ...
 *Modified by:PK                                                       *
 *Modification log: Calendar placeholder for roadmap, added date time functionality,                               *
 ***
 ******************************************************************** */
...
window.onload = function () {
	...
	$("month_year").firstChild.nodeValue = getMonthText(thisMonth) + " " + today.getDay() + " " + today.getFullYear() + " @ " + hr + ":" + min + ampm;
